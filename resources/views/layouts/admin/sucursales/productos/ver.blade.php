                    ...
                    <form id="editProductForm" enctype="multipart/form-data">
                        ...
                        <div class="row mb-3">
                            <div class="col-md-3">
                                ...
                                <input type="text" name="codigo" class="form-control" id="edit_codigo"
                                    placeholder="M-##">
                            </div>
                            <div class="col-md-9">
                        ...
                        <div class="row mb-3">
                            <div class="col-md-3">
                                ...
                                <input type="text" name="precio" class="form-control" id="edit_precio"
                                    placeholder="Precio del producto" step="0.01" min="0">
                            </div>
                            <div class="col-md-9">
                                <label for="edit_imagen" class="form-label">Nueva Imagen (Opcional)</label>
                                <input type="file" name="imagen" class="form-control" id="edit_imagen">
                        ...
                        <div class="row mb-3">
                            <div class="col-md-12">
                                <label for="edit_descripcion" class="form-label">Detalle producto</label>
                                <textarea name="descripcion" id="edit_descripcion" rows="3" class="form-control"
                        ...
                        <div class="modal-footer mt-3">
                            <button type="button" class="btn bg-danger" data-bs-dismiss="modal"
                                style="color: white;">Cerrar</button>
                            <button type="submit" class="btn btn-warning updateProductBtn">Actualizar Producto</button>
                        </div>
                    </form>
                </div>
            </div>
                ...
                <div class="col-xl-4 col-md-6">
                    <div class="card card-height-100">
                        ...
                        <div class="card-body text-center">
                            ...
                            <a href="{{ route('admin.sucursales.categorias.productos.ver', $subcategoria_asociada->id) }}" class="btn btn-info">Ver Productos</a>
                        </div>
                    </div>
                </div>
            @endforeach
